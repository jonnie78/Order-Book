...
//Constructor
Generator::Generator(double order_rate, uint32_t num_clients, uint32_t min_quantity, uint32_t max_quantity, double reference_price, double mean_price_offset) 
    : rng(374), //can change to random seed
      ...
      price_offset_dist(1 / mean_price_offset),
      type_dist(0.5){
        order_id_tracker = 1;
        ref = reference_price;
      } 
